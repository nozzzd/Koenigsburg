...
function Button() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="inline-flex items-center justify-center gap-2 rounded-lg border border-gold-500/40 px-4 py-2 text-xs font-semibold tracking-wider text-gold-300 transition hover:border-gold-400 hover:bg-gold-400/10 disabled:opacity-60"
    >
      {pending ? (
