...
export const goldButtonClass =
  "btn-gold inline-flex w-full items-center justify-center gap-2 rounded-lg px-4 py-2.5 font-display text-sm font-bold tracking-wider transition disabled:cursor-not-allowed disabled:opacity-60";
...
export const heroCtaClass =
  "btn-gold inline-flex items-center justify-center gap-2.5 rounded-xl px-10 py-4 font-display text-base font-bold tracking-widest shadow-lg shadow-gold-500/20 transition hover:shadow-gold-500/30";
