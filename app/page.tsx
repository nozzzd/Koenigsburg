...
const pillars = [
  {
    icon: ScrollText,
    title: "Citizenship",
    text: "Petition through Discord or online. Approved citizens gain special rights.",
  },
  {
    icon: Landmark,
    title: "The Nation",
  ...
  },
  {
    icon: Crown,
    title: "The Council",
    text: "Every petition is reviewed by the council. Once approved, you're free to enter.",
  },
];
