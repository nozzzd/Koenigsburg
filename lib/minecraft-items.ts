// AUTO-GENERATED from PrismarineJS minecraft-data (pc 1.21.11 items.json).
// The canonical set of real, obtainable Minecraft item ids (no namespace).
// Used to reject phantom items (e.g. "minecraft:oak") from the build planner.
// Regenerate from:
//   https://raw.githubusercontent.com/PrismarineJS/minecraft-data/master/data/pc/1.21.11/items.json

export const MINECRAFT_ITEM_IDS: readonly string[] = [
  "acacia_boat",
  "acacia_button",
  "acacia_chest_boat",
  "acacia_door",
...
const ITEM_SET = new Set(MINECRAFT_ITEM_IDS);
