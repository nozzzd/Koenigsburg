...
import { CalendarDays, Crown, KeyRound, ShieldCheck, Swords, UserRound } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <Panel className="space-y-3 p-6">
        ...
        <p className="text-sm leading-relaxed text-slate-400">
          If your session is lost or you change devices, enter the gates again with your
          Minecraft name and this code. Guard it well —{" "}
          ...
          <Panel className="flex items-center justify-between p-6 transition hover:border-gold-500/50">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                Review the whitelisting queue and open the gates.
              </p>
            </div>
